...
//           <Text style={styles.headText}>Farmly</Text>
//           {/* {t('Farmly')} */}
//           <TouchableOpacity
//             style={styles.icon}
...
//               <Text style={styles.headText1}>Recommended</Text>
//               {/* {t('recommended')} {t('view_all')} */}
...
//           <View>
//             <View style={styles.recHead}>
//               <Text style={styles.headText1}>Explore Farms</Text>
//               <TouchableOpacity style={styles.viewBtn}>
//                 <Text style={styles.viewText}>View all</Text>
//                 {/* {t('view_all')} {t('Explore_Farms')} */}
//                 <MaterialIcons
//                   name="chevron-right"
//                   size={20}
//                   style={styles.icon1}
...
//           <View>
//             <View style={styles.recHead}>
//               <Text style={styles.headText1}>Best Deals</Text>
//               <TouchableOpacity style={styles.viewBtn}>
//                 <Text style={styles.viewText}>View all</Text>
//                 {/* {t('Best_Deals')} {t('view_all')} */}
//                 <MaterialIcons
//                   name="chevron-right"
//                   size={20}
//                   style={styles.icon1}
